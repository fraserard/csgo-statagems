...
export type GetMatchListQuery = { __typename?: 'Query', matches: Array<{ __typename?: 'Match', datePlayed: any, id: string, score: string, map: { __typename?: 'Map', id: string, mapName: string }, teams: Array<{ __typename?: 'MatchTeam', id: string, matchPlayers: Array<{ __typename?: 'MatchPlayer', id: string, playerId: number, avatar: { __typename?: 'AvatarUrl', smallAvatarUrl: string } }> }> }> };
